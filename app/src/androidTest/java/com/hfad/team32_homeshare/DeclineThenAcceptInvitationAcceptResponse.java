...
public class DeclineThenAcceptInvitationAcceptResponse {
...
//        appCompatEditText13.perform(scrollTo(), click());
    ...
    @Test
    public void Step3_User2DeclinesThenAcceptsInv() {
        // Added a sleep statement to match the app's execution delay.
        // The recommended way to handle such scenarios is to use Espresso idling resources:
        // https://google.github.io/android-testing-support-library/docs/espresso/idling-resource/index.html
        try {
        ...
        ViewInteraction appCompatEditText4 = onView(
                allOf(withId(R.id.searchInvite),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText4.perform(replaceText("test user"), closeSoftKeyboard());
        ...
        ViewInteraction materialButton5 = onView(
                allOf(withId(R.id.recoverDeclinedInv), withText("Recover Declined Invitations"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.frame_layout),
                                        0),
    ...
    @Test
    public void Step5_User1AcceptsResponse() {
        // Added a sleep statement to match the app's execution delay.
        // The recommended way to handle such scenarios is to use Espresso idling resources:
        // https://google.github.io/android-testing-support-library/docs/espresso/idling-resource/index.html
        try {
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.emailEt),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText3.perform(replaceText("test@email.com"));
        ...
        ViewInteraction appCompatEditText7 = onView(
                allOf(withId(R.id.respondEt),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText7.perform(replaceText("Accepted"), closeSoftKeyboard());

        ViewInteraction materialButton4 = onView(
                allOf(withId(R.id.submitMessage), withText("Accept Response"),
                        childAtPosition(
                                allOf(withId(R.id.respondTil),
                                        childAtPosition(
                                                withClassName(is("android.widget.LinearLayout")),
                                                0)),
                                1),
    ...
    @Test
    public void Step7_User2SendsMessageFromResponse() {
        // Added a sleep statement to match the app's execution delay.
        // The recommended way to handle such scenarios is to use Espresso idling resources:
        // https://google.github.io/android-testing-support-library/docs/espresso/idling-resource/index.html
        try {
        ...
        ViewInteraction materialButton3 = onView(
                allOf(withId(R.id.messageSendBtn),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("androidx.cardview.widget.CardView")),
                                        0),
        ...
        ViewInteraction appCompatEditText5 = onView(
                allOf(withId(R.id.respondEt),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText5.perform(replaceText("Thanks"), closeSoftKeyboard());
    ...
    @Test
    public void Step8_User2SignsOut() {
        try {
            Thread.sleep(500);
        } catch (InterruptedException e) {
            e.printStackTrace();
    ...
    @Test
    public void Step9A_User1DeclinesResponseDeletesInv() {
        // Added a sleep statement to match the app's execution delay.
        // The recommended way to handle such scenarios is to use Espresso idling resources:
        // https://google.github.io/android-testing-support-library/docs/espresso/idling-resource/index.html
        try {
    ...
    @Test
    public void Step9B_User1SignsOut() {
        try {
            Thread.sleep(500);
        } catch (InterruptedException e) {
            e.printStackTrace();
